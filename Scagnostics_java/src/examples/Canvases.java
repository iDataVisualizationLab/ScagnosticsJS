...
//        Renderers.drawMST(dt, g, Color.green, 20, 20, size, size, 0, 1000);
        Renderers.drawHull(dt,g, Color.BLACK, 10, 10, size, size, 0, 1000);
        Renderers.drawShape(dt,g, Color.red, 10, 10, size, size, 0, 1000);
...
*/
		...
		//Renderers.drawShape(t,g, index, frame.getWidth()/3 + 110 ,20 , size,  frame.getWidth(),  0, 1000)
		//*****************************************************  
